...
class AnalysesControllerTest < ActionController::TestCase
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post :create, analysis: { description: @analysis.description, end_date: @analysis.end_date, start_date: @analysis.start_date }
    end
  ...
  test "should update analysis" do
    patch :update, id: @analysis, analysis: { description: @analysis.description, end_date: @analysis.end_date, start_date: @analysis.start_date }
    assert_redirected_to analysis_path(assigns(:analysis))
  end
